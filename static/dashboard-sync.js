/**
 * Zmart Trading Bot Dashboard Synchronization Script
 * 
 * This script synchronizes the dashboard with Airtable data by:
 * 1. Fetching the latest prices from the Vercel API
...
(function() {
  ...
  // Configuration
  const SERVER_URL = 'https://zmart-dashboard.vercel.app';
  ...
  function addSyncPricesButton() {
    ...
    if (updateDataButton && updateDataButton.parentNode) {
      ...
      if (existingSyncButton) {
        ...
        existingSyncButton.onclick = updateDashboardPrices;
        return;
      }
      ...
      // Add click handler
      syncButton.onclick = updateDashboardPrices;
